...
namespace Bme121
{
    static class Program
    {
        ...
        static void SelectSort( int[ ] a, out int[ ] swaps )
        {
            swaps = new int[0];
            ...
            for( int firstUnsorted = 0; firstUnsorted < a.Length - 1; firstUnsorted ++ )
            {
                ...
                // assign the position of the swaps
        ...
        static void UndoSelectSort(int[] a, int[] swaps )
        {
            if (a == null) throw new ArgumentNullException(nameof(a));
            if (a.Length < 1) throw new ArgumentOutOfRangeException(nameof(a));
        ...
        static void Main( )
        {
            ...
            SelectSort( data, out int[] arrayOfSwaps );
            
            WriteLine();
            WriteLine("Exchanges array");
            WriteArrayOneLine(arrayOfSwaps, "i", nameof(arrayOfSwaps));
            
            WriteLine( );
            WriteLine( "Sorted array" );
            WriteArrayOneLine( data, "i", nameof( data ) );
            
            UndoSelectSort(data, arrayOfSwaps );
